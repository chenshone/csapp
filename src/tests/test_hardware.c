...
static void TestSumRecursiveCondition() {
  ...
  match = match && (read64bits_dram(va2pa(0x7ffffffee230, cr), cr) ==
                    0x0000000008000650); // rbp
  match = match && (read64bits_dram(va2pa(0x7ffffffee228, cr), cr) ==
                    0x0000000000000006);
  match = match && (read64bits_dram(va2pa(0x7ffffffee220, cr), cr) ==
                    0x00007ffffffee310); // rsp
